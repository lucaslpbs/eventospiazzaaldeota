...
const menus: Record<string, { items: string[]; note?: string }> = {
  bronze: {
    items: [
      "☕ Café, chá e água aromatizada",
      "🥤 Suco natural (1 sabor)",
      "🥐 Mini croissant",
      "🥖 Pão de queijo",
      "🍪 Biscoitos amanteigados",
      "🍰 Bolo da casa (1 sabor)",
      "🍓 Frutas da estação",
    ],
  },
  prata: {
    items: [
      "☕ Café, chá, água aromatizada e chocolate quente",
      "🥤 2 sucos naturais",
      "🥐 Mini croissant + folhados",
      "🥖 Pão de queijo + mini sanduíches",
      "🧀 Tábua de queijos finos",
      "🍰 Bolos artesanais (2 sabores)",
      "🍫 Brigadeiros gourmet",
      "🍓 Frutas da estação premium",
    ],
  },
  ouro: {
    items: [
      "☕ Estação de café especial + chás importados",
      "🥤 3 sucos naturais + água saborizada",
      "🥐 Croissants, folhados e brioches",
      "🥖 Mini sanduíches gourmet",
      "🧀 Tábua de queijos e charcutaria",
      "🍣 Mini canapés finos",
      "🍰 Mesa de doces assinatura",
      "🍓 Frutas exóticas e nacionais",
      "🍷 Espumante (opcional)",
    ],
    note: "Inclui finger food. Adicione 2ª opção de finger por +R$10,00/pax.",
  },
};
